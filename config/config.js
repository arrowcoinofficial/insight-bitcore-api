...
if (!dataDir) {
  ...
  if (isLinux) dataDir = process.env.HOME + '/.Arrowcoin/';
}
...
var bitcoindConf = {
  ...
  user: process.env.BITCOIND_USER || 'Arrowcoinrpc',
  pass: process.env.BITCOIND_PASS || '622bmA7bxbVdsq6pgHqZKmfhzhf23Q1UvuoAXc7qEhRp',
  host: process.env.BITCOIND_HOST || '127.0.0.1',
  port: process.env.BITCOIND_PORT || b_port,
  p2pPort: process.env.BITCOIND_P2P_PORT || '4210',
